  ...
  var translate = {
    ...
    */
    getTranslation: function (msgid, n, context, defaultPlural, language) {
      ...
      if ( language === void 0 ) language = this.config.language;
      ...
      var silent = this.config.getTextPluginSilent || (this.config.getTextPluginMuteLanguages.indexOf(language) !== -1);
      ...
      // https://www.gnu.org/software/gettext/manual/html_node/Language-Codes.html#Language-Codes
      var languageTranslations = this.translations[language] || this.translations[language.split('_')[0]];
      ...
      var translated = languageTranslations[msgid];
      ...
      if (!translated && SPACING_RE.test(msgid)) {
        Object.keys(languageTranslations).some(function (key) {
    ...
    */
    'gettext': function (msgid, language) {
      ...
      return translate.getTranslation(msgid, 1, null, null, language || this.config.language)
    },
